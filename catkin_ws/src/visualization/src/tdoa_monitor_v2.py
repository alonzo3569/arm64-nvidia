...
class PLOT:
    ...
    def __init__(self):
        ...
        self.line1, = self.ax1.plot([], [], color='C8')#, color='blue', linestyle='-', linewidth=1)
        self.line2, = self.ax1.plot([], [], color='C9')#, color='red', linestyle='-', linewidth=1)
        self.line3, = self.ax2.plot([], [], color='C8')#, color='blue', linestyle='-', linewidth=1)
        self.line4, = self.ax2.plot([], [], color='C9')#, color='red', linestyle='-', linewidth=1)
        self.line5, = self.ax3.plot([], [], color='C8')#, color='blue', linestyle='-', linewidth=1)
        self.line6, = self.ax3.plot([], [], color='C3')#, color='red', linestyle='-', linewidth=1)
        ...
        self.ax4.plot(0, 0, color='red', marker='o', markersize=8)
        self.ax4.set_title('TDOA')
    ...
    def animation_frame(self,i):
        ...
        if self.t_axis.shape[0] == self.plot_array_ch1.shape[0]:
            ...
            # plot current quiver
            #self.line[6].set_UVC(self.x_vector,self.y_vector)
            #line = ax4.quiver(0, 0, 0, 1, color='red', scale = 2, width=0.02)
            self.ax4.quiver(0, 0, self.x_vector, self.y_vector, color='C10', scale = 2, width=0.02)
            self.ax4.plot(0, 0, color='red', marker='o', markersize=8)
