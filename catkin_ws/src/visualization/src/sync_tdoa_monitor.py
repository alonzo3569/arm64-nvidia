...
from ntu_msgs.msg import HydrophoneData, HydrophoneFFTData, SyncTdoa
...
class PLOT:
    ...
    def __init__(self):
        ...
        self.tdoa_window_length= rospy.get_param('~tdoa_window_length', 0.1) #sec
        ...
        # Subscriber
        rospy.Subscriber("sync_tdoa", SyncTdoa, self.tdoa_cb)
